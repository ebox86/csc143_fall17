...
public abstract class Seat {
	 ...
	 * @param recline
	 *            -- the number of inches of recline room for the seat
	 * @param meal
	 *            -- the meal choice for the seat
	 * @throws IllegalArgumentException
	 */
	public Seat(int row, int col, double price, int recline, mealType meal, Flight flight, classType seatClass)
			throws IllegalArgumentException {
		if (price <= 0.0) {
	...
	public String toString() {
		String returnString = "Seat number: " + getSeatId() + ", " + " seatPrice: " + getCalculatedPrice() + ", "
				+ " meal: " + getMeal().toString() + ", " + " recline: " + getRecline() + ", " + " class: "
	...
	// used to convert an integer value to its corresponding ASCII
	// representation
