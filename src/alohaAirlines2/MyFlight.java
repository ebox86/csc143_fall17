...
public class MyFlight {
	...
	public static void main(String[] args) throws Exception {
		...
		Flight myFlight = new Flight("A1101", "OHR", "SEA", "2017/01/01", 1.0);
		System.out.println(myFlight.toString());
		myFlight.bookSeat(3, 3, "Guy", "093234", "Economy", false);
		myFlight.bookSeat(1, 4, "Guy", "093234", "First Class", true);
		myFlight.bookSeat(30, 6, "bill", "123123", "Comfort", true);
