...
public class Flight {
	 ...
	 * @throws Exception
	 */
	public Flight(String id, String origin, String destination, String date, double basePrice)
	...
	public Seat getSeat(int row, int col, String seatClass) {
		...
		/*
		 * if(seatClass == "Economy"){ Seat tempSeatArr = seatArr[0][row];
		 * return tempSeatArr; } else if(seatClass == "Comfort") { Seat[]
		 * tempSeatArr = seatArr[1]; return tempSeatArr[row - 1][col -1]; }
		 */
	}
	 ...
	 * @throws Exception
	 */
	public void bookSeat(int row, int col, String name, String code, String seatClass, boolean clubMember)
			throws Exception {
		Seat s = null;
